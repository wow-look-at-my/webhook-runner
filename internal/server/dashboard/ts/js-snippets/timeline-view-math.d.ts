 ...
 */
export declare const CLUSTER_JOIN_PX = 12;
 ...
 * positions.
 */
export declare function clusterInstants(items: readonly PackItem[], view: TimeView, plotWidth: number, joinPx?: number, instantPx?: number): {
