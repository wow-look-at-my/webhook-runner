...
| `WEBHOOK_RUNNER_STATS_URL`        | (none)                       | Base URL of a [simple-stats-api](https://github.com/wow-look-at-my/simple-stats-api) instance (e.g. `http://stats:3847`). The dashboard graphs host cpu/ram/disk/net/gpu from it in the title bar. Unset = the dashboard says no stats source is configured. |
